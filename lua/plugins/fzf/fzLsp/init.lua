...
-- Modified by me, Brendan Armstrong
...
local diagnostics_fmt = {
	[vim.diagnostic.severity.ERROR] = { text = "Error", label = "DiagnosticError" },
	[vim.diagnostic.severity.WARN] = { text = "Warn", label = "DiagnosticWarn" },
	[vim.diagnostic.severity.INFO] = { text = "Info", label = "DiagnosticInfo" },
	[vim.diagnostic.severity.HINT] = { text = "Hint", label = "DiagnosticHint" },
}
...
local function lsp_to_fzf(item)
	...
	local path = fmt("%s", util.magenta(filename, "Label"))
	local lnum = fmt("%s", util.green(item.lnum, "Float"))
...
local function build_fzf_opts(label, preview, multi)
	...
	if opts.fzf_action and not vim.tbl_isempty(opts.fzf_action) then
		vim.list_extend(fzf_opts, {
			"--expect",
			table.concat(vim.tbl_keys(opts.fzf_action), ","),
		})
	end

	-- Enable preview with fzf.vim
	if preview and opts.fzf_preview and vim.g.loaded_fzf_vim then
		local args = vim.fn["fzf#vim#with_preview"](table.unpack(opts.fzf_preview)).options
...
local function diagnostics_cmd(diagnostics)
	...
	for _, diagnostic in ipairs(diagnostics) do
		...
		table.insert(items, {
			...
			text = fmt("[%s] %s", util.red(severity.text, severity.label), diagnostic.message),
...
-- ["$/progress"] = <function 1>,
-- ["callHierarchy/incomingCalls"] = <function 2>,
-- ["callHierarchy/outgoingCalls"] = <function 3>,
-- ["client/registerCapability"] = <function 4>,
-- ["client/unregisterCapability"] = <function 5>,
-- hover = <function 6>,
-- signature_help = <function 7>,
-- ["textDocument/codeLens"] = <function 8>,
-- ["textDocument/completion"] = <function 9>,
-- ["textDocument/declaration"] = <function 10>,
-- ["textDocument/definition"] = <function 11>,
-- ["textDocument/documentHighlight"] = <function 12>,
-- ["textDocument/documentSymbol"] = <function 13>,
-- ["textDocument/formatting"] = <function 14>,
-- ["textDocument/hover"] = <function 15>,
-- ["textDocument/implementation"] = <function 16>,
-- ["textDocument/publishDiagnostics"] = <function 17>,
-- ["textDocument/rangeFormatting"] = <function 18>,
-- ["textDocument/references"] = <function 19>,
-- ["textDocument/rename"] = <function 20>,
-- ["textDocument/signatureHelp"] = <function 21>,
-- ["textDocument/typeDefinition"] = <function 22>,
-- ["window/logMessage"] = <function 23>,
-- ["window/showDocument"] = <function 24>,
-- ["window/showMessage"] = <function 25>,
-- ["window/showMessageRequest"] = <function 26>,
-- ["window/workDoneProgress/create"] = <function 27>,
-- ["workspace/applyEdit"] = <function 28>,
-- ["workspace/configuration"] = <function 29>,
-- ["workspace/executeCommand"] = <function 30>,
-- ["workspace/semanticTokens/refresh"] = <function 31>,
-- ["workspace/symbol"] = <function 32>,
-- ["workspace/workspaceFolders"] = <function 33>
...
M.setup = function(user_opts)
	...
	vim.api.nvim_create_user_command("FzfLspDiagnostics", function(_)
		local bufnr = vim.api.nvim_get_current_buf()
		diagnostics_cmd(vim.diagnostic.get(bufnr))
	end, {})
	vim.api.nvim_create_user_command("FzfLspDiagnosticsAll", function(_)
		diagnostics_cmd(vim.diagnostic.get())
	end, {})
	vim.api.nvim_create_user_command("FzfFuzzyLast", function(_)
		last_results_cmd()
	end, {})
	vim.api.nvim_create_user_command("FzfSymbols", function(_)
